...
#define USER_MAX_STACK (8 * 1024 * 1024)
...
/* Returns true if VADDR is a under 8 MB limit of user stack. */
static inline bool
is_user_limit (const void *vaddr) 
{
  return PHYS_BASE - vaddr <= USER_MAX_STACK;
}
